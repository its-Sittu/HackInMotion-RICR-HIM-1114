      ...
      <main className="dash-main">
        ...
        <header className="dash-header">
          <div className="dash-greeting">
            ...
            <p className="dash-subtitle">Here is your daily health summary and medical vital report.</p>
          </div>
          ...
          <div className="dash-header-actions">
            <div className="dash-search-box">
              ...
              <input type="text" placeholder="Search records, vitals, doctors..." />
            </div>
